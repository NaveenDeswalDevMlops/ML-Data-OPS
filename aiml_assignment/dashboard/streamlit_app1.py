...
if page == "Home":
    ...
    st.markdown("Generate real-time churn predictions using the Telco feature schema.")
    st.info("This dashboard uses Telecom churn data for prediction and model training.")
